...
from steer.headers import Simple
from steer.headers import Multipart
...
class Upload:
    ...
    def multipart(self, file = None, metadata = None):
        ...
        multipart_ = Multipart(self.data['token'])
